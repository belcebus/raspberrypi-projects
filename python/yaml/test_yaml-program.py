...
class TestParams(unittest.TestCase):
    def test_param_count(self):
        ...
        with self.assertRaises(SystemExit):
            sys.argv = ['yaml-program.py']
            exec(open('yaml-program.py').read())

        with self.assertRaises(SystemExit):
            sys.argv = ['yaml-program.py', 'arg1', 'arg2', 'arg3', 'arg4', 'arg5']
            exec(open('yaml-program.py').read())

    def test_param_values_add(self):
        # Verificar que los parámetros se escriben correctamente en el archivo YAML
        prepare_file()
        sys.argv = ['yaml-program.py', 'versions_file_test.yml','modulo-4', '4.3.2', '5b5fea19460958d008f85ec85705bba23b3ce348', 'https://github.com/organizacion/modulo-4.git']
        exec(open('yaml-program.py').read())
    ...
    def test_param_values_update(self):
        # Verificar que los parámetros se escriben correctamente en el archivo YAML
        prepare_file()
        sys.argv = ['yaml-program.py', 'versions_file_test.yml', 'modulo-1', '1.0.1', '6ce3b73b522f917bacb943c06927e95c0ad6122c', 'https://github.com/organizacion/modulo-1.git']
        exec(open('yaml-program.py').read())
